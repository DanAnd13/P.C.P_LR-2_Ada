pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__lr2.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__lr2.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_lr2");
...
--  BEGIN Object file/option list
   --   E:\Flash\P.C.P\LR2\LR2_Ada\obj\lr2.o
   --   -LE:\Flash\P.C.P\LR2\LR2_Ada\obj\
   --   -LE:\Flash\P.C.P\LR2\LR2_Ada\obj\
   --   -LD:/programs/ada/lib/gcc/x86_64-w64-mingw32/10.3.1/adalib/
   --   -static
   --   -lgnarl
   --   -lgnat
   --   -Xlinker
